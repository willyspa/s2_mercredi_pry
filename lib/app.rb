...
# appel le fichier .env grace a la gem dotenv
def login_twitter
...
def  favorite(login_def)

login_def.search("#bonjour_monde", result_type: "recent").take(5).collect do |i|
login_def.favorite(i.id)
end
...
def follow(login_def)
login_def.search("#bonjour_monde", result_type: "recent").take(15).collect do |i|
login_def.follow(i.user)
end
...
#client.update('@MSession7 Давай! Давай! ')
